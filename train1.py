...
def train(arglist):
    ...
    with U.single_threaded_session():
        ...
        while True:
            # get action
            action_n = [agent.action(obs) for agent, obs in zip(trainers,obs_n)]#？，right,left,up,down
            # environment step
            ...
            adversary0_reward += rew_n[0]
            adversary1_reward += rew_n[1]
            adversary2_reward += rew_n[2]
            agent0_reward += rew_n[3]
            ...
            obs_n = new_obs_n
            # data=[-0.1, -0.1, -0.2, -1.2]
            # obs_n[0] =np.array(data)
            # rew_n=[-80,-80,80
            ...
            if len(episode_rewards) > arglist.num_episodes:
                ...
                print('...total adversary0_reward is %f' %(adversary0_reward ))
                print('...total adversary0_reward is %f' % (adversary1_reward))
                print('...total adversary0_reward is %f' % (adversary2_reward))
